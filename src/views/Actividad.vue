  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Sé creativo
        p.mb-4 Conectar los conocimientos sobre lectura, escritura y el aporte de escritores colombianos con la construcción de guiones turísticos creativos, que impacten al visitante en cualquier región de Colombia.
